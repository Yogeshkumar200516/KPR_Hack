...
import BillingAddressManager from "../pages/ReturnStock/ReturnStock";
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Routes>
          ...
          <Route
            path="/admin-access"
            element={<PrivateRoute element={UserBillingToggle} roles={["admin"]} />}
          />
          ...
          <Route
            path="/return-stock"
            element={
              <PrivateRoute element={BillingAddressManager} roles={["admin"]} />
            }
          />
