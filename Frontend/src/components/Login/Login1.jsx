...
const LoginPage = ({ onLogin }) => {
  ...
  try {
    ...
    // ✅ Store subscription_type if present
    if (company?.subscription_type) {
      localStorage.setItem("subscriptionType", company.subscription_type);
      console.log("✅ Stored subscriptionType:", company.subscription_type);
    } else {
      localStorage.removeItem("subscriptionType");
    }

    // ⬅️ **Add this console.log to always display in console after login**
    console.log("📦 Subscription Type from backend:", company?.subscription_type);
    ...
    console.log("✅ Stored tokenExpiry:", localStorage.getItem("tokenExpiry"));
